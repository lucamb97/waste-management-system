...
public class WorkerServiceTest {
    ...
    void testPlotWorkerRouteWithBins() {
        ...
        Bin bin1 = new Bin(1L, 120, city, "TestRoad1", "Test1",0.0f ,0.0f  , "TestUser1", true, false, "WORKING");
        Bin bin2 = new Bin(2L, 100, city, "TestRoad2", "Test2",20.0f ,15.0f  , "TestUser2", true, false, "WORKING");
        Bin bin3 = new Bin(3L, 150, city, "TestRoad3", "Test3",1.0f ,0.0f  , "TestUser3", true, false, "WORKING");
        Bin bin4 = new Bin(4L, 90, city, "TestRoad4", "Test4",10.0f ,10.0f  , "TestUser4", true, false, "WORKING");
        Bin bin5 = new Bin(5L, 190, city, "TestRoad5", "Test5",10.0f ,10.0f  , "TestUser4", true, false, "WORKING");
